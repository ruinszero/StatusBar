...
class ImmersionDelegate implements Runnable {
    ...
    ImmersionDelegate(Object o) {
        if (o instanceof AppCompatActivity) {
            if (mImmersionBar == null) {
                mImmersionBar = new ImmersionBar((AppCompatActivity) o);
            }
    ...
    ImmersionDelegate(AppCompatActivity activity, Dialog dialog) {
        if (mImmersionBar == null) {
    ...
    public void run() {
        if (mImmersionBar != null && mImmersionBar.getActivity() != null) {
            AppCompatActivity activity = mImmersionBar.getActivity();
