...
import static com.ruinszero.statusbar.Constants.IMMERSION_EMUI_NAVIGATION_BAR_HIDE_SHOW;
import static com.ruinszero.statusbar.Constants.IMMERSION_MIUI_NAVIGATION_BAR_HIDE_SHOW;
import static com.ruinszero.statusbar.Constants.IMMERSION_NAVIGATION_BAR_HEIGHT;
import static com.ruinszero.statusbar.Constants.IMMERSION_NAVIGATION_BAR_HEIGHT_LANDSCAPE;
import static com.ruinszero.statusbar.Constants.IMMERSION_NAVIGATION_BAR_WIDTH;
import static com.ruinszero.statusbar.Constants.IMMERSION_STATUS_BAR_HEIGHT;
...
class BarConfig {
     ...
     */
    BarConfig(AppCompatActivity activity) {
    ...
    private int getNavigationBarHeight(Context context) {
        int result = 0;
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            if (hasNavBar((AppCompatActivity) context)) {
                String key;
                if (mInPortrait) {
    ...
    @TargetApi(14)
    private boolean hasNavBar(AppCompatActivity activity) {
