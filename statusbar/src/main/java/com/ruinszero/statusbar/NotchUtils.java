...
public class NotchUtils {
     ...
     * @return the boolean
     */
    public static boolean hasNotchScreen(AppCompatActivity activity) {
     ...
     * @return the boolean
     */
    private static boolean hasNotchAtAndroidP(AppCompatActivity activity) {
     ...
     */
    private static DisplayCutout getDisplayCutout(AppCompatActivity activity) {
     ...
     * @return the int
     */
    public static int getNotchHeight(AppCompatActivity activity) {
        int notchHeight = 0;
