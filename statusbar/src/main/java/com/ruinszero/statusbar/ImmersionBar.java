...
import static com.ruinszero.statusbar.Constants.*;
...
public final class ImmersionBar implements ImmersionCallback {
     ...
     */
    public static ImmersionBar with(@NonNull AppCompatActivity activity) {
     ...
     * @return the immersion bar
     */
    public static ImmersionBar with(@NonNull AppCompatActivity activity, @NonNull Dialog dialog) {
     ...
     * @param dialog   the dialog
     */
    public static void destroy(@NonNull AppCompatActivity activity, @NonNull Dialog dialog) {
    ...
    private void setSpecialBarDarkMode() {
        if (OSUtils.isMIUI6Later()) {
            //修改miui状态栏字体颜色
            SpecialBarFontUtils.setMIUIBarDark(window, IMMERSION_MIUI_STATUS_BAR_DARK, mBarParams.statusBarDarkFont);
            //修改miui导航栏图标为黑色
            if (mBarParams.navigationBarEnable) {
                SpecialBarFontUtils.setMIUIBarDark(window, IMMERSION_MIUI_NAVIGATION_BAR_DARK, mBarParams.navigationBarDarkIcon);
            }
        }
        // 修改Flyme OS状态栏字体颜色
    ...
    private int initBarAboveLOLLIPOP(int uiFlags) {
        //获得默认导航栏颜色
        if (!mInitialized) {
            mBarParams.defaultNavigationBarColor = window.getNavigationBarColor();
        }
        ...
        if (mBarParams.statusBarColorEnabled) {
            window.setStatusBarColor(ColorUtils.blendARGB(mBarParams.statusBarColor,
        ...
        //设置导航栏颜色
        if (mBarParams.navigationBarEnable) {
            window.setNavigationBarColor(ColorUtils.blendARGB(mBarParams.navigationBarColor,
                    mBarParams.navigationBarColorTransform, mBarParams.navigationBarAlpha));
        } else {
            window.setNavigationBarColor(mBarParams.defaultNavigationBarColor);
        }
        return uiFlags;
    }
    ...
    private void setupStatusBarView() {
        View statusBarView = decorView.findViewById(IMMERSION_ID_STATUS_BAR_VIEW);
    ...
    private void setupNavBarView() {
        View navigationBarView = decorView.findViewById(IMMERSION_ID_NAVIGATION_BAR_VIEW);
    ...
    private void fitsWindowsAboveLOLLIPOP() {
        updateBarConfig();
        if (checkFitsSystemWindows(decorView.findViewById(android.R.id.content))) {
            setPadding(0, 0, 0, 0);
            return;
        }
        int top = 0;
    ...
    public void onNavigationBarChange(boolean show) {
        ...
        if (navigationBarView != null) {
            mBarConfig = new BarConfig(mActivity);
            int bottom = contentView.getPaddingBottom(), right = contentView.getPaddingRight();
            if (!show) {
                //导航键隐藏了
                navigationBarView.setVisibility(View.GONE);
                bottom = 0;
            ...
            setPadding(0, contentView.getPaddingTop(), right, bottom);
        }
    }
     ...
     * @param view      the view
     */
    public static void setTitleBar(final FragmentActivity activity, int fixHeight, View... view) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
            if (activity == null) {
                return;
            }
     ...
     * @param view     the view
     */
    public static void setTitleBar(final AppCompatActivity activity, View... view) {
    ...
    public static void setTitleBar(Fragment fragment, View... view) {
        ...
        setTitleBar((AppCompatActivity) fragment.getActivity(), view);
    }
     ...
     * @param view      the view
     */
    public static void setTitleBarMarginTop(AppCompatActivity activity, int fixHeight, View... view) {
        if (activity == null) {
            return;
        }
        if (fixHeight < 0) {
     ...
     * @param view     the view
     */
    public static void setTitleBarMarginTop(AppCompatActivity activity, View... view) {
    ...
    public static void setTitleBarMarginTop(Fragment fragment, int fixHeight, View... view) {
        ...
        setTitleBarMarginTop((AppCompatActivity) fragment.getActivity(), fixHeight, view);
    }
    ...
    public static void setTitleBarMarginTop(Fragment fragment, View... view) {
        ...
        setTitleBarMarginTop((AppCompatActivity) fragment.getActivity(), view);
    }
     ...
     * @param view      the view
     */
    public static void setStatusBarView(AppCompatActivity activity, int fixHeight, View... view) {
        if (activity == null) {
            return;
        }
        if (fixHeight < 0) {
     ...
     * @param view     the view
     */
    public static void setStatusBarView(AppCompatActivity activity, View... view) {
    ...
    public static void setStatusBarView(Fragment fragment, int fixHeight, View... view) {
        ...
        setStatusBarView((AppCompatActivity) fragment.getActivity(), fixHeight, view);
    }
    ...
    public static void setStatusBarView(Fragment fragment, View... view) {
        ...
        setStatusBarView((AppCompatActivity) fragment.getActivity(), view);
    }
     ...
     */
    public static void setFitsSystemWindows(AppCompatActivity activity, boolean applySystemFits) {
        if (activity == null) {
            return;
        }
    ...
    public static void setFitsSystemWindows(AppCompatActivity activity) {
    ...
    public static void setFitsSystemWindows(Fragment fragment, boolean applySystemFits) {
        ...
        setFitsSystemWindows((AppCompatActivity) fragment.getActivity(), applySystemFits);
    }
    ...
    public static void setFitsSystemWindows(Fragment fragment) {
        ...
        setFitsSystemWindows((AppCompatActivity) fragment.getActivity());
    }
     ...
     */
    @TargetApi(14)
    public static boolean hasNavigationBar(@NonNull AppCompatActivity activity) {
    ...
    public static boolean hasNavigationBar(@NonNull Fragment fragment) {
        ...
        return hasNavigationBar((AppCompatActivity) fragment.getActivity());
    }
     ...
     */
    @TargetApi(14)
    public static int getNavigationBarHeight(@NonNull AppCompatActivity activity) {
        BarConfig config = new BarConfig(activity);
    ...
    public static int getNavigationBarHeight(@NonNull Fragment fragment) {
        ...
        return getNavigationBarHeight((AppCompatActivity) fragment.getActivity());
    }
     ...
     */
    @TargetApi(14)
    public static int getNavigationBarWidth(@NonNull AppCompatActivity activity) {
        BarConfig config = new BarConfig(activity);
    ...
    public static int getNavigationBarWidth(@NonNull Fragment fragment) {
        ...
        return getNavigationBarWidth((AppCompatActivity) fragment.getActivity());
    }
     ...
     */
    @TargetApi(14)
    public static boolean isNavigationAtBottom(@NonNull AppCompatActivity activity) {
        BarConfig config = new BarConfig(activity);
    ...
    public static boolean isNavigationAtBottom(@NonNull Fragment fragment) {
        ...
        return isNavigationAtBottom((AppCompatActivity) fragment.getActivity());
    }
     ...
     */
    @TargetApi(14)
    public static int getStatusBarHeight(@NonNull AppCompatActivity activity) {
        BarConfig config = new BarConfig(activity);
    ...
    public static int getStatusBarHeight(@NonNull Fragment fragment) {
        ...
        return getStatusBarHeight((AppCompatActivity) fragment.getActivity());
    }
     ...
     */
    @TargetApi(14)
    public static int getActionBarHeight(@NonNull AppCompatActivity activity) {
        BarConfig config = new BarConfig(activity);
    ...
    public static int getActionBarHeight(@NonNull Fragment fragment) {
        ...
        return getActionBarHeight((AppCompatActivity) fragment.getActivity());
    }
     ...
     * @return the boolean
     */
    public static boolean hasNotchScreen(@NonNull AppCompatActivity activity) {
    ...
    public static boolean hasNotchScreen(@NonNull Fragment fragment) {
        ...
        return hasNotchScreen((AppCompatActivity) fragment.getActivity());
    }
     ...
     * @return the int
     */
    public static int getNotchHeight(@NonNull AppCompatActivity activity) {
    ...
    public static int getNotchHeight(@NonNull Fragment fragment) {
        ...
        return getNotchHeight((AppCompatActivity) fragment.getActivity());
    }
     ...
     * @param activity the activity
     */
    ImmersionBar(AppCompatActivity activity) {
        mIsActivity = true;
        mActivity = activity;
    ...
    ImmersionBar(DialogFragment dialogFragment) {
        ...
        mActivity = (AppCompatActivity) dialogFragment.getActivity();
     ...
     * @param dialog   the dialog
     */
    ImmersionBar(AppCompatActivity activity, Dialog dialog) {
        mIsDialog = true;
        mActivity = activity;
        this.dialog = dialog;
        checkInitWithActivity();
        initCommonParameter(this.dialog.getWindow());
    }
    ...
    private void initCommonParameter(Window window) {
        ...
        decorView = (ViewGroup) this.window.getDecorView();
    ...
    public ImmersionBar fitsSystemWindowsInt(boolean fits, @ColorInt int contentColor
        ...
        contentView.setBackgroundColor(ColorUtils.blendARGB(mBarParams.contentColor,
    ...
    public ImmersionBar titleBar(@IdRes int viewId, boolean statusBarColorTransformEnable) {
        if (fragment != null && fragment.getView() != null) {
            return titleBar(fragment.getView().findViewById(viewId), statusBarColorTransformEnable);
        } else if (fragment != null && fragment.getView() != null) {
            return titleBar(fragment.getView().findViewById(viewId), statusBarColorTransformEnable);
        } else {
    ...
    public ImmersionBar titleBarMarginTop(@IdRes int viewId) {
        if (fragment != null && fragment.getView() != null) {
            return titleBarMarginTop(fragment.getView().findViewById(viewId));
        } else if (fragment != null && fragment.getView() != null) {
            return titleBarMarginTop(fragment.getView().findViewById(viewId));
        } else {
